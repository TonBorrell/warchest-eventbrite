...
if __name__ == "__main__":
    ...
    print(
        "Before starting the game you can see all the players that have already played warchest, their wins and when did they do it."
    )
    print(old_players_sorted)
    print(
        "Welcome to the Warchest game, first of all you are going to enter the names of the 2 players"
    )
